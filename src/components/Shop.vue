<template>
  <section class="shop">
        ...
        <div class="col-md-3 col-12">
          <div class="d-flex catalog__topfilters">
            ...
            <div class="filtcontm">
              ...
              <div class="dropdown">
                <button
                  class="btn dropdown-toggle dropdown__filters"
                  type="button"
                  id="dropdownMenuButton"
                  data-toggle="dropdown"
                  aria-haspopup="true"
                ...
                >
                  ...
                  <img
                    src="@/assets/img/catalogArrowM.png"
                    class="catalog__ArrowImg"
                    alt=""
                  />
                </button>
                <div
                  class="dropdown-menu catalog__dropmenu"
                ...
                >
                  <a
                    ...
                    :class="[
                      'dropdown-item',
                      'catalog__dropitem',
                      { catalog__dropitemBorder: rarity.id != 5 },
                      { active: rarity.id == this.rareSelect },
                    ]"
                ...
                >
                  <a
                    ...
                    :class="[
                      'dropdown-item',
                      'catalog__dropitem',
                      { catalog__dropitemBorder: condition.id != 5 },
                      { active: condition.id == this.conditionSelect },
                    ]"
                  >
                    {{ condition.cond }}
                  </a>
            ...
            <button class="btn filter__button">Применить фильтр</button>
          </div>
        </div>
            ...
            <div class="shop-container">
              <div class="row filtersAndCatalog">
                <div class="col-12 col-md-12 catalog">
                  ...
                  <div
                    class="item"
                    v-for="item in pageWeaponsList"
                    :key="item.id"
                    @click="openModal(item._id['$oid'])"
                  >
                    <div class="item__top">
    ...
    <div class="container-fluid cont__pd mt-4"></div>
...
export default {
  ...
  methods: {
    ...
    openModal(id) {
      ...
      this.modal.modalProductName = this.weapons.filter(
  ...
  computed: {
    filteredWeapons() {
      ...
      if (this.rareSelect != 0) {
        searched = searched.filter((product) => {
          return (
            ...
            this.rarityList[this.rareSelect].rare.toLowerCase()
          );
        });
      }
      if (this.conditionSelect != 0) {
        searched = searched.filter((product) => {
          return (
            product.quality == this.conditionList[this.conditionSelect].short
          );
        });
      }
    ...
    pageWeaponsList() {
      if (this.filteredWeapons.length > 0) {
        ...
        for (
          let i = ind;
          i <= ind + 19 && i < this.filteredWeapons.length;
          i++
        ) {
