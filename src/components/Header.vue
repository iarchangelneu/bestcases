<template>
  <div class="header">
    ...
    <div>
      <router-link to="/"><img src="../assets/img/newlogo.svg" alt="logo" class="logo__img" /></router-link>
    </div>
    <div class="navbar" v-if="IsLogged">
      ...
      <div class="walletCont">
        <img class="walletImg" src="../assets/img/walletsvg.svg" alt="" style="width: 1.25vw" />
        <div class="purse__count">{{ userBalance }} ₸</div>
        <div class="popolnit" @click="topupMoney">+ пополнить</div>
      </div>
      <div class="user">
        <img src="../assets/img/avatarn.svg" alt="" style="width: 3.75vw" class="accountHeaderImgPC" />
        <div class="dropdown">
          <img src="../assets/img/avatarn.svg" alt="" style="" class="accountHeaderImgM" />
    ...
    <div class="sign__in" v-else>
      ...
      <form action="https://steamcommunity.com/openid/login" method="post">
        ...
        <input type="hidden" name="openid.realm" value="https://bestcases.kz/" />
        <input type="hidden" name="openid.return_to" value="https://bestcases.kz/error" />
...
export default {
  ...
  mounted() {
    ...
    if (this.IsLogged) {
      ...
      axios({
        method: 'get',
        url: `https://bestcases.kz/api/get_user_openid/${decoded.open_id}`,
      })
        .then((response) => {
